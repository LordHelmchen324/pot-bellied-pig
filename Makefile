mac2019:
	gcc *.c source/*.c source/graphics/*.c maps/*.c -o potbellied -F/Library/Frameworks -I/Library/Frameworks/SDL2.framework/Headers -framework SDL2 -I/Library/Frameworks/SDL2_image.framework/Headers -framework SDL2_image -I/Library/Frameworks/SDL2_ttf.framework/Headers -framework SDL2_ttf
